...
class Catalogo (pelicula):
    ...
    def remove_movie(self, pelicula): 
        try: 
...
if not os.path.exists(file_directory):
    os.makedirs(file_directory)
    pelicula_1 = pelicula("Pyton", "terror", 1.50, 2000, 3.00, "catalogo.txt")
    pelicula_2 = pelicula("Sonrie", "terror", 1.56, 2022, 3.6,  "catalogo.txt")
    pelicula_3 = pelicula("Siniestro", "terror", 1.50, 2012, 4.2, "catalogo.txt")
